...
The inventory list always sorts by soonest-to-expire (perishable date) first — FIFO order — and no edit or addition may ever cause older stock to display below newer stock.
